...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection conEQ)
    {
    ...
    public static int InsertUserRoles(SqlConnection conEQ, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection conEQ, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection conEQ, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection conEQ, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection conEQ, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection conEQ, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection conEQ, UserRolesAccess cat)
    {
        int result = 0;
