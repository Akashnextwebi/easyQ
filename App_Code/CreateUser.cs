...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection conEQ)
    {
        List<CreateUser> companies = new List<CreateUser>();
        try
        {
            //string query = "Select *, (Select top 1 RoleName From UserRoles Where UserRoles.Id=CreateUser.UserRole) as UserRoleName, (Select top 1 UserName From CreateUser Where UserGuid=CreateUser.AddedBy) as AddedBy1 from CreateUser where Status !='Deleted'";
            string query = @"SELECT *,
                                  (SELECT TOP 1 RoleName 
                                   FROM UserRoles 
                                   WHERE UserRoles.Id = CreateUser.UserRole) AS UserRoleName,
                                  (SELECT TOP 1 UserName 
                                   FROM CreateUser AS CU2 
                                   WHERE CU2.UserGuid = CreateUser.AddedBy) AS AddedBy1
                                   FROM CreateUser
                                WHERE Status != 'Deleted'
                                ";
            using (SqlCommand cmd = new SqlCommand(query, conEQ))
            {
                ...
                companies = (from DataRow dr in dt.Rows
                             select new CreateUser()
                             {
                                 ...
                                 UserRole = Convert.ToString(dr["UserRoleName"]),
    ...
    public static CreateUser GetUserDetails(SqlConnection conEQ, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection conEQ, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection conEQ, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection conEQ, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection conEQ, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection conEQ, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection conEQ, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection conEQ, CreateUser loginInputs)
    {
    ...
    public static CreateUser Login2(SqlConnection conEQ, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection conEQ, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection conEQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection conEQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection conEQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection conEQ, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection conEQ, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection conEQ, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection conEQ, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection conEQ, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection conEQ, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection conEQ, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection conEQ)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection conEQ, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(conEQ, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(conEQ, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(conEQ, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(conEQ, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(conEQ, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
