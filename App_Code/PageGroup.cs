...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection conEQ)
    {
    ...
    public static int InsertPageGroup(SqlConnection conEQ, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection conEQ, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection conEQ, PageGroup cat)
    {
        int result = 0;
