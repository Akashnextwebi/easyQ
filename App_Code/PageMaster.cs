...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conEQ)
    {
    ...
    public static int InsertPageMaster(SqlConnection conEQ, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conEQ, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conEQ, PageMaster cat)
    {
        int result = 0;
