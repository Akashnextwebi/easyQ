            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box text-start">
                        <h1 class="text-anime-style-2 text-start">About Us</h1>
                    ...
                    <div class="about-us-content text-center">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                easyQ Solutions is a deep tech startup pioneering AI-powered, cloud-native electronic Quality Management
              Systems (eQMS) designed exclusively for the medical device industry.
                            </p>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Our goal is to transform outdated, manual, and siloed quality processes with a smart, cohesive platform
              that accelerates time-to-market, increases operational effectiveness, and promotes regulatory
              compliance.

                            </p>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                End-to-end Quality System Requirements are fully met by our eQMS, which is completely align with:
                            </p>
                        </div>
                        <!-- Section Title End -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="company-activity-box">
                        ...
                        <div class="company-activity-item">
                            ...
                            <!-- Company Activity Content Start -->
                            <div class="company-activity-content">
                                <!-- Section Tite Start -->
                                <div class="section-title">
                                    <h2 class="text-anime-style-2" data-cursor="-opaque">Our Commitment
                                    </h2>
                                    <p class="wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                        easyQ Solutions supports startups, SMEs, and  large enterprises  in navigating the complex compliance landscapes across the globe. around the world by offering both next-generation software and expert-led regulatory advice.
                                    </p>
                        ...
                        <!-- Company Activity Item End -->

                        <!-- Company Activity Item Start -->

                        <!-- Company Activity Item End -->
                    </div>
                    <!-- Company Activity Box End -->
                </div>
            </div>
        </div>
    </div>
