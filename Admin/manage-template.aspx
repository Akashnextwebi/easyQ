<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="manage-template.aspx.cs" Inherits="Admin_manage_template" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><%=Request.QueryString["id"]==null?"Add":"Update" %> Templates</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1"><%=Request.QueryString["id"]==null?"Add":"Update" %> Templates</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <label>Template Title<sup>*</sup></label>
                                    <asp:TextBox runat="server" MaxLength="150" class="form-control mb-2 mr-sm-2" ID="txtTemplate" />
                                    <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="txtTemplate" Display="Dynamic" ForeColor="Red" SetFocusOnError="true" ValidationGroup="Save" ErrorMessage="Field can't be empty"></asp:RequiredFieldValidator>
                                </div>
                                ...
                                <div class="col-lg-5 mb-2">
                                    ...
                                    <small style="color: red;">Allow only .png, .jpeg, .jpg, .webp formats and size must be 650×450 px.</small><br />
                                    <%=strImage %>
                                </div>

                                <div class="col-lg-5 mb-2">
                                    <label>Upload Template<sup>*</sup></label>
                                    <asp:FileUpload CssClass="form-control" ID="TemplateDocument" runat="server" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Manage Templates</h4>
                        </div>
                        <div class="card-body">
    ...
    <script src="assets/js/pages/manage-template.js"></script>
</asp:Content>
