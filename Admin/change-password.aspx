                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-4">
                                    ...
                                    <div class="position-relative auth-pass-inputgroup">
                                        <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 password" TextMode="Password" ID="txtCurrent" MaxLength="100" placeholder="Enter Current password"/>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>New Password</label><sup>*</sup>
                                    <div class="position-relative auth-pass-inputgroup">
                                        <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 password-input password" TextMode="Password" ID="txtNew" placeholder="Enter New password"/>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>Confirm New Password</label><sup>*</sup>
                                    <div class="position-relative auth-pass-inputgroup">
                                        <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 password" TextMode="Password" ID="txtConfirm" placeholder="Re-Enter New Password"/>
                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button"><i class="ri-eye-fill align-middle"></i></button>
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div id="password-contain" class="p-3 bg-light mb-2 password-contain rounded">
                                        ...
                                        <p id="pass-lower" class="invalid fs-12 mb-2">Atleast one <b> lowercase</b> letter (a-z)</p>
                                        <p id="pass-upper" class="invalid fs-12 mb-2">Atleast one <b> uppercase</b> letter (A-Z)</p>
                                        <p id="pass-number" class="invalid fs-12 mb-2">Atleast one <b> number</b> (0-9)</p>
                                        <p id="pass-special" class="invalid fs-12 mb-0">Atleast one <b> Special character</b> (~!@#$%^&*(),.?":{}|<>)</p>
                                    </div>
